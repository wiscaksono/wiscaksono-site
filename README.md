...
lease review the [license](https://github.com/wiscaksono/wiscaksono-site/blob/main/LICENSE.txt) and remove all of my personal information (resume, blog posts, images, etc.) by running `pnpm run setup`.
