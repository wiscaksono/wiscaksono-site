    ...
    <FadeIn>
      <article>
        <div className='space-y-2 mb-2.5 pb-2.5 border-b'>
          <h1 className='text-3xl font-semibold'>Code that i wrote this week</h1>
        ...
        {data.map(item => (
          <pre className='flex items-center' key={item.name}>
            <code className='text-muted-foreground w-36 truncate shrink-0 flex items-center gap-x-2'>
              <div
