...
![Wiscaksono Setup](https://wiscaksono-next.vercel.app/_next/image?url=%2Fsetup.jpg&w=3840&q=75)

export default ({children}) => <article className="prose p-5">{children}</article>
